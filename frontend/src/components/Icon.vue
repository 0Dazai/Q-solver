<template>
  ...
  >
    ...
    <template v-else-if="name === 'brain'">
      ...
      <path d="M12 2a5 5 0 0 0-4.54 2.88A4.5 4.5 0 0 0 3 9.5a4.5 4.5 0 0 0 2.4 3.98A5 5 0 0 0 12 18" />
      <path d="M12 18v4" />
      <path d="M8 10h.01" />
      <path d="M16 10h.01" />
